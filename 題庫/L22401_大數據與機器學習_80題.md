...
<span style="color: white">**解析：** 數據品質是機器學習的上限，模型只是逼近這個上限。</span>
...
<span style="color: white">**解析：** 大數據能提供更全面的樣本分佈，減少估計變異，特別是對深度學習這種「數據飢渴」的模型。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 大數據相當於一種強力的正則化手段，強迫模型學習真正的模式而非噪聲。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 強調了 Data-Centric AI 的重要性。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 傳統淺層模型的容量有限，難以消化海量數據帶來的信息。</span>
...
<span style="color: white">**解析：** 深度神經網絡的高自由度（參數多）需要大量樣本約束。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 例如在基因數據中發現致病模式，或在用戶行為中發現隱性興趣。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 數據密度增加有助於緩解稀疏性，但高維度處理的運算壓力依然存在。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 好的特徵能讓簡單模型表現得像複雜模型一樣好。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 專家知識往往能轉化為強力的特徵，減少模型探索成本。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 常用於圖像和語音領域，以低成本擴充數據集並提高模型魯棒性。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 機器學習模型本質上是數學運算，只能處理數值向量。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 標註成本高昂，需要更聰明的策略來獲取標籤。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 訓練數據與線上數據分佈不一致，是模型部署後的主要風險。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 大部分樣本聚集在少數熱門類別，導致模型對冷門類別預測準確度低。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 這是數據治理的標準維度。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 巧婦難為無米之炊，信息含量是預測的基礎。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 在廣告點擊率預測等超大規模場景，簡單模型（如 LR）依然是基石。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 這是機器學習中最常見也最致命的錯誤之一。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 如深度學習直接從像素識別物體，跳過了手工設計邊緣檢測等環節。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 這是最常用的並行策略，每個節點算一部分數據的梯度，然後匯總。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 將神經網絡的不同層或不同部分分配到不同設備上計算。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** Worker 負責算，Server 負責記，是分散式 ML 的經典架構。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 優點是收斂穩定（等同於大 Batch），缺點是受限於最慢的節點 (木桶效應)。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 缺點是會引入「梯度陳舊 (Stale Gradients)」問題，影響收斂。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 通過環狀傳遞，讓帶寬利用率最優化，無需中心化的瓶頸節點。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 用時間換空間，解決顯存不足無法開大 Batch 的問題。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 計算和存儲用 FP16 加速且省顯存，關鍵參數更新用 FP32 保持精度。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** FP16 的表示範圍小，微小的梯度可能會變成 0，放大後可保留精度。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 這是限制分散式擴展效率的主要瓶頸。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 所有人都得等最慢的那個，嚴重拖累整體速度。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 由 Uber 開源，基於 MPI 和 NCCL，易於與 TF/PyTorch 集成。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** PS 架構特別適合存儲並查詢巨大的稀疏參數矩陣。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 隱私保護下的分散式訓練。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 根據 Linear Scaling Rule，Batch 變大，LR 也應成比例變大。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 防止大 LR 在訓練初期導致模型震盪或發散。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 節點越多，故障機率越高，Checkpoints 至關重要。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 將模型切分後，利用流水線技術減少設備空閒時間 (Bubble)。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 不保存所有中間激活值，反向傳播時臨時重算，節省顯存。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** DeepSpeed 的核心技術，讓普通 GPU 集群也能訓練大模型。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 在同步與非同步之間的折衷。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 理解這一點對調整學習率至關重要。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** NVIDIA 的高速互連技術，大幅提升多卡並行效率。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 減少 I/O 開銷，避免小文件問題。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 線上服務更看重響應速度。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 將數據投影到變異數最大的正交方向上。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** t-SNE 能很好地展示簇的結構，但計算複雜度高，不適合轉換新數據。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 速度快，作為預處理步驟。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 針對特定模型優化特徵子集，容易過擬合且慢。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 結合了 Filter 和 Wrapper 的優點。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 類別太多會產生幾萬個 0 和一個 1，浪費空間且難學。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** Embedding 將其映射為低維稠密向量。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 如「女性」且「喜歡化妝品」，組合特徵往往比單獨特徵更有預測力。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 相比多項式回歸，FM 能在稀疏數據下泛化學習二階交互。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** Wide 記住規則，Deep 負責泛化。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 不同量綱的特徵會讓 Loss Surface 變成橢圓，導致優化困難。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 嚴格來說 A 是最基礎的方法，不算高級；D 常常很有效，因為缺失本身就是信息。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 犧牲少量衝突換取空間和效率，常用於在線學習。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 深度學習時代，CNN 已經取代了大部分手工特徵。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 降低常見詞 (如 "的", "是") 的權重。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 將詞映射為語義空間的稠密向量。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 捕捉時間序列的局部趨勢和波動。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 衡量特徵對降低熵 (不確定性) 的貢獻。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 樹模型對單調變換不敏感。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 需要去除相關性過高的冗餘特徵。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 降低機器學習門檻，提升效率。</span>
...
<span style="color: white">**正確答案：C**</span>  
<span style="color: white">**解析：** 協同過濾依賴歷史行為，冷啟動正是因為沒有行為，所以失效。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 模型壓縮與加速的重要技術。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 如 XGBoost 的 `gain` 或 Shuffle Importance，用於可解釋性。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 最難檢測的漂移類型。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 數十億的 Feature ID。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 即時性最高的學習方式，如 FTRL 算法。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 離線指標好不代表線上效果好，必須做 A/B Test。</span>
...
<span style="color: white">**正確答案：A**</span>  
<span style="color: white">**解析：** 邊緣計算的關鍵技術。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 處理節點與邊的關係。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 目前最流行的模型可解釋性 (XAI) 工具之一。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 將連續變數離散化，讓線性模型能擬合分段非線性關係。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** Batch Size 越大，噪音越小，但泛化能力可能變差。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 這就是為什麼 Spark (基於內存) 取代了 Hadoop MapReduce 用於 ML。</span>
...
<span style="color: white">**正確答案：B**</span>  
<span style="color: white">**解析：** 邁向通用人工智能 (AGI) 的方向。</span>
